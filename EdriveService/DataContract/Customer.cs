...
namespace EdriveService.DataContract
{
    ...
    public  class Customer
    {
       ...
       [DataMember] public String customerGUID { get; set; }
       ...
       [DataMember] public Int32 customerType { get; set; }
        
       [DataMember] public string email { get; set; }
        
       //[DataMember] public String passwordHash { get; set; }
        
       //[DataMember] public bool saltKey { get; set; }
        
       [DataMember] public bool active { get; set; }
        
       [DataMember] public DateTime registrationDate { get; set; }
       ...
       [DataMember] public bool isTrial { get; set; }

       [DataMember] public String Gender { get; set; }

       [DataMember] public String FirstName { get; set; }

       [DataMember] public Int32 Zip { get; set; }
       ...
       [DataMember] public String StreetAddress2 { get; set; }
         ...
         [DataMember] public String City { get; set; }
           ...
           [DataMember] public Int32 StateID { get; set; }
           [DataMember]
           ...
           [DataMember] public Boolean Newsletter { get; set; }
           [DataMember] public Boolean IsFeatured { get; set; }
