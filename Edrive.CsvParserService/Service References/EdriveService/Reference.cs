...
namespace Edrive.CsvParserService.EdriveService {
    ...
    public partial class Products : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Edrive.CsvParserService.EdriveService.Customer CustomerField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Edrive.CsvParserService.EdriveService.Customer Customer {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="EdriveService.IEdrive_Service")]
    public interface IEdrive_Service {
        ...
        bool AddDealer(Edrive.CsvParserService.EdriveService.Customer cust, ref string Msg, Edrive.CsvParserService.EdriveService._CustomerProfile Profile);
        ...
        bool Update_Dealer(Edrive.CsvParserService.EdriveService.Customer cust, ref string Msg, Edrive.CsvParserService.EdriveService._CustomerProfile Profile);
        ...
        bool UpdateAdmin_InfoDetails(Edrive.CsvParserService.EdriveService.Customer cust, ref string Msg);
        ...
        bool Update_Dealer_Personal_Details(out string Msg, Edrive.CsvParserService.EdriveService.Customer _customer);
        ...
        Edrive.CsvParserService.EdriveService.ED_Zipcodes GetED_ZipCodes(string ZipCode);
        ...
        Edrive.CsvParserService.EdriveService.Products[] GetHotSheet(out int CarsCount, System.Nullable<double> latitude, System.Nullable<double> longitude, double NewLatitude, double NewLongitude, int makeID, string Zipcode, int pageIndex, int pageSize);
        ...
        bool Authenticate_Dealer_or_Admin(string UserName, string Password, string RoleName, ref Edrive.CsvParserService.EdriveService.Customer customer);
        ...
        Edrive.CsvParserService.EdriveService.Customer GetDealerByDealerEmail(string Email);
        ...
        Edrive.CsvParserService.EdriveService.Customer GetDealerByDealerID(System.Nullable<int> CustomerID);
        ...
        Edrive.CsvParserService.EdriveService._CustomerProfile GetDealer_Profile_ByDealerID(System.Nullable<int> CustomerID);
        ...
        Edrive.CsvParserService.EdriveService._SellerCount GetSellerCount_for_HotSheet(string zip, System.Nullable<int> Make, System.Nullable<double> lat1, System.Nullable<double> lat2, System.Nullable<double> long1, System.Nullable<double> long2);
        ...
        Edrive.CsvParserService.EdriveService.Customer[] SearchDealer_For_ManagDealerSection(out int CarsCount, string CompanyName, string CompanyName2, string Email, string LastName, string Name, System.Nullable<System.DateTime> RegFrom, System.Nullable<System.DateTime> RegTo, int pageIndex, int pageSize);
        ...
        bool IntrestedCustomer(Edrive.CsvParserService.EdriveService.IntrestedCustomer _customer, int _productid);
        ...
        Edrive.CsvParserService.EdriveService.Products[] SearchProductBy_Make_Model_City_Zip(
                    string searchKey, 
                    int pageSize, 
                    int pageIndex, 
        ...
        Edrive.CsvParserService.EdriveService.IntrestedCustomer[] Get_InterestedCustomer(int InterestType);
        ...
        Edrive.CsvParserService.EdriveService.Products[] SearchCars_for_home_Page(string searchKey, int Counts_to_ret);
        ...
        Edrive.CsvParserService.EdriveService.Products[] GetProductByIDs(int[] productIDs);
        ...
        Edrive.CsvParserService.EdriveService.Products[] Get_FeaturedVehicles(int VehCounts);
        ...
        Edrive.CsvParserService.EdriveService.Products[] GetProductsByDealerID(int DealerID);
        ...
        Edrive.CsvParserService.EdriveService.ProductOptions[] GetAllProductOptions();
        ...
        Edrive.CsvParserService.EdriveService.ProductOptions[] GetAllProductOptions_By_ProductID(int ProductID);
        ...
        Edrive.CsvParserService.EdriveService.Product_Make GetMakeById(int makeId);
        ...
        Edrive.CsvParserService.EdriveService.Product_Body GetBodybyId(int bodyid);
        ...
        Edrive.CsvParserService.EdriveService.Product_Model GetModelbyId(int ModelID);
        ...
        Edrive.CsvParserService.EdriveService.Customer GetDealerbyProductID(int ProductID);
        ...
        Edrive.CsvParserService.EdriveService.Products[] SearchProduct_for_ManageProduct(string VIN, string Stock, int makeId, string _ComapnyName, string _DealerEmail, string RoleName, bool isOnlyFeatured, int pageIndex, int pageSize, ref int CarsCount);
        ...
        Edrive.CsvParserService.EdriveService.Customer[] GetDealers();
        ...
        Edrive.CsvParserService.EdriveService.Customer[] GetDealers_for_ManageProoduct(int CountDownDays);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEdrive_Service/Get_Count_SearchProduct_for_ManageProduct", ReplyAction="http://tempuri.org/IEdrive_Service/Get_Count_SearchProduct_for_ManageProductRespo" +
            "nse")]
        int Get_Count_SearchProduct_for_ManageProduct(string VIN, string Stock, int makeId, string _ComapnyName, string _DealerEmail, string RoleName, bool isOnlyFeatured);
        ...
        bool QualifyPriceofProduct(string[] ProductIDs);
        ...
        Edrive.CsvParserService.EdriveService.Product_Picture[] GetProductPicture_By_ProductID(int ProductID);
        ...
        Edrive.CsvParserService.EdriveService.Products UpdateProduct(out bool status, Edrive.CsvParserService.EdriveService.Products Prd, ref string Msg, string[] OptionsID);
        ...
        bool Update_Product_Picture(ref Edrive.CsvParserService.EdriveService.Product_Picture[] Pictures, out string Msg, int ProductID);
        ...
        Edrive.CsvParserService.EdriveService.Country[] GetCountry();
        ...
        Edrive.CsvParserService.EdriveService.State[] GetStateByCountry(int CountryID);
        ...
        Edrive.CsvParserService.EdriveService.State GetState_Detail_By_StateID(int StateID);
        ...
        Edrive.CsvParserService.EdriveService.Products[] Get_Dealers_FeaturedVehicle(int rec_to_return);
        ...
        Edrive.CsvParserService.EdriveService.Products[] SearchCars(
                    string Price, 
                    string Milage, 
                    string Make, 
                    string ModelID, 
        ...
        Edrive.CsvParserService.EdriveService.Products[] searchProduct(int makeID, int modelId, string zipCode, int pageSize, int pageIndex, ref System.Nullable<int> CarsCount, string SortByColumn);
        ...
        Edrive.CsvParserService.EdriveService.Products AddProduct(out bool status, Edrive.CsvParserService.EdriveService.Products Prd, ref string Msg, string[] OptionsID);
        ...
        int GetAdvancedSearchProducts_Count(Edrive.CsvParserService.EdriveService.AdvancedSearchAttributes _attributes);
        ...
        Edrive.CsvParserService.EdriveService.Products[] GetAdvancedSearchProducts(Edrive.CsvParserService.EdriveService.AdvancedSearchAttributes _attributes, int pageSize, int pageIndex, string SortByColumn);
        ...
        Edrive.CsvParserService.EdriveService.Product_Model[] BindModel(int makeid);
        ...
        Edrive.CsvParserService.EdriveService.Product_Make[] BindMake();
        ...
        Edrive.CsvParserService.EdriveService.Product_Make[] bindMakeAttributes();
        ...
        Edrive.CsvParserService.EdriveService.Product_Type[] bindtypeAttributes();
        ...
        Edrive.CsvParserService.EdriveService.Product_Body[] BindBodyType();
        ...
        Edrive.CsvParserService.EdriveService.Products[] GetTransmission();
        ...
        Edrive.CsvParserService.EdriveService.Products[] GetEngine();
        ...
        Edrive.CsvParserService.EdriveService.Products GetProductByID(int ProductID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEdrive_ServiceChannel : Edrive.CsvParserService.EdriveService.IEdrive_Service, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Edrive_ServiceClient : System.ServiceModel.ClientBase<Edrive.CsvParserService.EdriveService.IEdrive_Service>, Edrive.CsvParserService.EdriveService.IEdrive_Service {
        ...
        public bool AddDealer(Edrive.CsvParserService.EdriveService.Customer cust, ref string Msg, Edrive.CsvParserService.EdriveService._CustomerProfile Profile) {
        ...
        public bool Update_Dealer(Edrive.CsvParserService.EdriveService.Customer cust, ref string Msg, Edrive.CsvParserService.EdriveService._CustomerProfile Profile) {
            return base.Channel.Update_Dealer(cust, ref Msg, Profile);
        }
        
        public bool UpdateAdmin_InfoDetails(Edrive.CsvParserService.EdriveService.Customer cust, ref string Msg) {
            return base.Channel.UpdateAdmin_InfoDetails(cust, ref Msg);
        }
        
        public bool Update_Dealer_Personal_Details(out string Msg, Edrive.CsvParserService.EdriveService.Customer _customer) {
            return base.Channel.Update_Dealer_Personal_Details(out Msg, _customer);
        }
        
        public Edrive.CsvParserService.EdriveService.ED_Zipcodes GetED_ZipCodes(string ZipCode) {
            return base.Channel.GetED_ZipCodes(ZipCode);
        }
        
        public Edrive.CsvParserService.EdriveService.Products[] GetHotSheet(out int CarsCount, System.Nullable<double> latitude, System.Nullable<double> longitude, double NewLatitude, double NewLongitude, int makeID, string Zipcode, int pageIndex, int pageSize) {
        ...
        public bool Authenticate_Dealer_or_Admin(string UserName, string Password, string RoleName, ref Edrive.CsvParserService.EdriveService.Customer customer) {
            return base.Channel.Authenticate_Dealer_or_Admin(UserName, Password, RoleName, ref customer);
        }
        
        public Edrive.CsvParserService.EdriveService.Customer GetDealerByDealerEmail(string Email) {
            return base.Channel.GetDealerByDealerEmail(Email);
        }
        
        public Edrive.CsvParserService.EdriveService.Customer GetDealerByDealerID(System.Nullable<int> CustomerID) {
            return base.Channel.GetDealerByDealerID(CustomerID);
        }
        
        public Edrive.CsvParserService.EdriveService._CustomerProfile GetDealer_Profile_ByDealerID(System.Nullable<int> CustomerID) {
            return base.Channel.GetDealer_Profile_ByDealerID(CustomerID);
        }
        
        public Edrive.CsvParserService.EdriveService._SellerCount GetSellerCount_for_HotSheet(string zip, System.Nullable<int> Make, System.Nullable<double> lat1, System.Nullable<double> lat2, System.Nullable<double> long1, System.Nullable<double> long2) {
            return base.Channel.GetSellerCount_for_HotSheet(zip, Make, lat1, lat2, long1, long2);
        }
        
        public Edrive.CsvParserService.EdriveService.Customer[] SearchDealer_For_ManagDealerSection(out int CarsCount, string CompanyName, string CompanyName2, string Email, string LastName, string Name, System.Nullable<System.DateTime> RegFrom, System.Nullable<System.DateTime> RegTo, int pageIndex, int pageSize) {
        ...
        public bool IntrestedCustomer(Edrive.CsvParserService.EdriveService.IntrestedCustomer _customer, int _productid) {
        ...
        public Edrive.CsvParserService.EdriveService.Products[] SearchProductBy_Make_Model_City_Zip(
                    string searchKey, 
                    int pageSize, 
                    int pageIndex, 
                    ref System.Nullable<int> CarsCount, 
                    ...
                    bool isSearchByDealer, 
                    int SearchByDealerID) {
            return base.Channel.SearchProductBy_Make_Model_City_Zip(searchKey, pageSize, pageIndex, ref CarsCount, SortByColumn, ref Price, ref Milage, ref Make, ref ModelID, ref Year, ref Body, ref Type, Zip, Warranty, ref Vin, Transmission, Engine, ref DriveType, isSearchByDealer, SearchByDealerID);
        }
        ...
        public void SearchProductBy_Make_Model_City_Zip_Count(
                    ...
                    bool isSearchByDealer, 
                    int SearchByDealerID) {
            base.Channel.SearchProductBy_Make_Model_City_Zip_Count(searchKey, pageSize, pageIndex, ref CarsCount, SortByColumn, ref Price, ref Milage, ref Make, ref ModelID, ref Year, ref Body, ref Type, Zip, Warranty, ref Vin, Transmission, Engine, ref DriveType, isSearchByDealer, SearchByDealerID);
        }
        ...
        public Edrive.CsvParserService.EdriveService.IntrestedCustomer[] Get_InterestedCustomer(int InterestType) {
        ...
        public Edrive.CsvParserService.EdriveService.Products[] SearchCars_for_home_Page(string searchKey, int Counts_to_ret) {
        ...
        public Edrive.CsvParserService.EdriveService.Products[] GetProductByIDs(int[] productIDs) {
            return base.Channel.GetProductByIDs(productIDs);
        }
        
        public Edrive.CsvParserService.EdriveService.Products[] Get_FeaturedVehicles(int VehCounts) {
        ...
        public Edrive.CsvParserService.EdriveService.Products[] GetProductsByDealerID(int DealerID) {
        ...
        public Edrive.CsvParserService.EdriveService.ProductOptions[] GetAllProductOptions() {
            return base.Channel.GetAllProductOptions();
        }
        
        public Edrive.CsvParserService.EdriveService.ProductOptions[] GetAllProductOptions_By_ProductID(int ProductID) {
        ...
        public Edrive.CsvParserService.EdriveService.Product_Make GetMakeById(int makeId) {
            return base.Channel.GetMakeById(makeId);
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Body GetBodybyId(int bodyid) {
            return base.Channel.GetBodybyId(bodyid);
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Model GetModelbyId(int ModelID) {
            return base.Channel.GetModelbyId(ModelID);
        }
        
        public Edrive.CsvParserService.EdriveService.Customer GetDealerbyProductID(int ProductID) {
            return base.Channel.GetDealerbyProductID(ProductID);
        }
        
        public Edrive.CsvParserService.EdriveService.Products[] SearchProduct_for_ManageProduct(string VIN, string Stock, int makeId, string _ComapnyName, string _DealerEmail, string RoleName, bool isOnlyFeatured, int pageIndex, int pageSize, ref int CarsCount) {
        ...
        public Edrive.CsvParserService.EdriveService.Customer[] GetDealers() {
            return base.Channel.GetDealers();
        }
        
        public Edrive.CsvParserService.EdriveService.Customer[] GetDealers_for_ManageProoduct(int CountDownDays) {
            return base.Channel.GetDealers_for_ManageProoduct(CountDownDays);
        }
        
        public bool DeleteProduct(string[] ProductIDs) {
            return base.Channel.DeleteProduct(ProductIDs);
        }
        
        public int Get_Count_SearchProduct_for_ManageProduct(string VIN, string Stock, int makeId, string _ComapnyName, string _DealerEmail, string RoleName, bool isOnlyFeatured) {
        ...
        public bool QualifyPriceofProduct(string[] ProductIDs) {
            return base.Channel.QualifyPriceofProduct(ProductIDs);
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Picture[] GetProductPicture_By_ProductID(int ProductID) {
            return base.Channel.GetProductPicture_By_ProductID(ProductID);
        }
        
        public Edrive.CsvParserService.EdriveService.Products UpdateProduct(out bool status, Edrive.CsvParserService.EdriveService.Products Prd, ref string Msg, string[] OptionsID) {
            return base.Channel.UpdateProduct(out status, Prd, ref Msg, OptionsID);
        }
        
        public bool Update_Product_Picture(ref Edrive.CsvParserService.EdriveService.Product_Picture[] Pictures, out string Msg, int ProductID) {
            return base.Channel.Update_Product_Picture(ref Pictures, out Msg, ProductID);
        }
        
        public Edrive.CsvParserService.EdriveService.Country[] GetCountry() {
            return base.Channel.GetCountry();
        }
        
        public Edrive.CsvParserService.EdriveService.State[] GetStateByCountry(int CountryID) {
            return base.Channel.GetStateByCountry(CountryID);
        }
        
        public Edrive.CsvParserService.EdriveService.State GetState_Detail_By_StateID(int StateID) {
        ...
        public Edrive.CsvParserService.EdriveService.Products[] Get_Dealers_FeaturedVehicle(int rec_to_return) {
        ...
        public Edrive.CsvParserService.EdriveService.Products[] SearchCars(
                    string Price, 
                    string Milage, 
                    string Make, 
                    string ModelID, 
        ...
        public Edrive.CsvParserService.EdriveService.Products[] searchProduct(int makeID, int modelId, string zipCode, int pageSize, int pageIndex, ref System.Nullable<int> CarsCount, string SortByColumn) {
        ...
        public Edrive.CsvParserService.EdriveService.Products AddProduct(out bool status, Edrive.CsvParserService.EdriveService.Products Prd, ref string Msg, string[] OptionsID) {
        ...
        public int GetAdvancedSearchProducts_Count(Edrive.CsvParserService.EdriveService.AdvancedSearchAttributes _attributes) {
            return base.Channel.GetAdvancedSearchProducts_Count(_attributes);
        }
        
        public Edrive.CsvParserService.EdriveService.Products[] GetAdvancedSearchProducts(Edrive.CsvParserService.EdriveService.AdvancedSearchAttributes _attributes, int pageSize, int pageIndex, string SortByColumn) {
            return base.Channel.GetAdvancedSearchProducts(_attributes, pageSize, pageIndex, SortByColumn);
        }
        
        public string[] BindDriveType() {
            return base.Channel.BindDriveType();
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Model[] BindModel(int makeid) {
            return base.Channel.BindModel(makeid);
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Make[] BindMake() {
            return base.Channel.BindMake();
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Make[] bindMakeAttributes() {
            return base.Channel.bindMakeAttributes();
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Type[] bindtypeAttributes() {
            return base.Channel.bindtypeAttributes();
        }
        
        public Edrive.CsvParserService.EdriveService.Product_Body[] BindBodyType() {
            return base.Channel.BindBodyType();
        }
        
        public Edrive.CsvParserService.EdriveService.Products[] GetTransmission() {
            return base.Channel.GetTransmission();
        }
        
        public Edrive.CsvParserService.EdriveService.Products[] GetEngine() {
            return base.Channel.GetEngine();
        }
        
        public Edrive.CsvParserService.EdriveService.Products GetProductByID(int ProductID) {
