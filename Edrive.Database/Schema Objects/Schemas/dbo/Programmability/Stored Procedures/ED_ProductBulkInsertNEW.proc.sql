...
-- EXEC [dbo].[ED_ProductBulkInsertNEW] 'D:\Nyusoft\Development\EDrive\Nirav_Test.CSV','37'
CREATE PROCEDURE [dbo].[ED_ProductBulkInsertNEW] --'D:\Nyusoft\Development\EDrive\Nirav_TestTwo.CSV','37'
	@File nvarchar(500),
	@CustomerID int
AS
BEGIN
...
---- for option attribute
 ...
 --   BEGIN
	...
	Select Distinct([3]),@CustomerID,[4]+' '+[5]+' '+[6],[1],SType.SpecificationAttributeOptionID,[2],[4],
			...
			[15],
			[16],[17],[18],[19],
			[20],[21],[22],[23],(SELECT OptionName FROM dbo.GetVehicleOptionsID(replace([24],'''','`'))),[25],SWarranty.SpecificationAttributeOptionID,[26],[27],[28],getdate(),3,'',[29],[30],[31],dbo.GetStateProvinceID([32])
	From #Temp as T 
