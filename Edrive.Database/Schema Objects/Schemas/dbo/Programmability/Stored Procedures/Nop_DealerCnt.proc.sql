---[dbo].[Nop_DealerCnt] 21212,'',39.356206,40.8038029889983,-82.5916924639456,-76.610989
--EXEC [dbo].[Nop_DealerCnt] 1901,'',42.461246,43.9088429889993,-75.1770877538163,-70.946743
--EXEC [dbo].[Nop_DealerCnt] 1901,'',0,0,0,0

CREATE PROCEDURE [dbo].[Nop_DealerCnt] --1901
(
	@ZipCode				int,
	@Make                   nvarchar(200),
	@Lat1					float,
...
BEGIN
	...
	set @Paramlist = '@ZipCode int ,@Make nvarchar(200),@Lat1 float,@Lat2 float,@Long1 float,@Long2 float'
