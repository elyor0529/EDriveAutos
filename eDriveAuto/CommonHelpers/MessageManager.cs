...
namespace Edrive.CommonHelpers
{
	public static class MessageManager
	{
		...
		public static void SendCustomerWelcomeMessage(Customer customer, int languageId)
		{
...
<td>Income Details</td><td>Created on</td> </tr></thead><tbody>");
		...
		public static void SendCustomerPasswordRecoveryMessage(Customer customer, EmailTemplate template)
		{
			if(customer == null)
				throw new ArgumentNullException("customer");
			...
			string subject = ReplaceMessageTemplateTokens(customer, template.Subject);
			string body = ReplaceMessageTemplateTokens(customer, template.Body);
