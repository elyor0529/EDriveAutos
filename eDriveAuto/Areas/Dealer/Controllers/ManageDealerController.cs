...
namespace Edrive.Areas.Dealer.Controllers
{
    ...
    public class ManageDealerController : Controller
    {
		...
		public ManageDealerController(IStateProvinceService stateProvinceService, ICountryService countryService)
		{
		...
		private void BindFilter()
        {
            ...
            var stateID = _stateProvinceService.GetStateByCountry(selectedCountryID).Select(m => new SelectListItem { Selected = (m.DisplayOrder == 1), Text = m.Name, Value = m.CountryID.ToString() }).ToList();
