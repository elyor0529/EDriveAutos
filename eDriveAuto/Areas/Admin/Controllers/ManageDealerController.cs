...
namespace Edrive.Areas.Admin.Controllers
{
    ...
    public class ManageDealerController : Controller
    {
		...
		public ManageDealerController(IDealerService dealerService, 
			ICustomerProfileService customerProfileService, IStateProvinceService stateProvinceService, ICountryService countryService)
		{
